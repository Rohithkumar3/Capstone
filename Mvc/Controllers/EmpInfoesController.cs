...
namespace Mvc.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public EmpInfoesController(CapstoneProject1Context context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmpInfo != null ? 
                          ...
                          Problem("Entity set 'CapstoneProject1Context.EmpInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CapstoneProject1Context.EmpInfo'  is null.");
            }
            var empInfo = await _context.EmpInfo.FindAsync(id);
            if (empInfo != null)
            {
