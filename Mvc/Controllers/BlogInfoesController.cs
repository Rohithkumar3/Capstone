...
namespace Mvc.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public BlogInfoesController(CapstoneProject1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BlogInfo != null ? 
                          ...
                          Problem("Entity set 'CapstoneProject1Context.BlogInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CapstoneProject1Context.BlogInfo'  is null.");
            }
            var blogInfo = await _context.BlogInfo.FindAsync(id);
            if (blogInfo != null)
            {
